...
for (const [cat, fileList] of Object.entries(categorizedFiles)) {
    ...
    fileList.forEach(filename => {
        ...
        const subItems = title.split(' & ');

        subItems.forEach(item => {
            const itemTitle = item.trim();
            const tips = "點擊圖片查看詳情。";
        ...
        <div class="item-row">
            ...
            <div class="item-middle">
                ...
                <div class="item-link-container"><a href="https://www.google.com/search?q=${itemTitle.replace(/ /g, '+')}+Tokyo" target="_blank" class="item-link">🔍 Google Search</a></div>
            </div>
